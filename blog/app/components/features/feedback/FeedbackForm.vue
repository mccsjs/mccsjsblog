  ...
  try {
    ...
    switch (formData.reportType) {
      ...
      case 'summary':
        ...
        reason =
          summaryIssueTypes.find(item => item.value === formData.summaryIssueType)?.label ||
    ...
    <form v-else @submit.prevent="handleSubmit">
      ...
      <template v-if="formData.reportType === 'suggestion'">
        ...
        <div class="form-group">
          ...
          <div class="info-text">可上传设计图、示意图等相关文件，帮助我们更好地理解您的建议</div>
          <div class="file-upload-section">
            <input
...
.feedback-form {
  ...
  .form-actions {
    ...
    .query-btn {
      background: transparent;
      color: var(--mccsjs-btn);
      border: 1px solid var(--mccsjs-btn);
  ...
  .dialog-header {
    ...
    border-bottom: 1px solid var(--mccsjs-border);
  ...
  .query-result {
    background: var(--mccsjs-light-bg);
    border: 1px solid var(--mccsjs-border);
    border-radius: 8px;
    padding: 1.5rem;
