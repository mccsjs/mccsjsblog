...
.modal-container {
  background-color: var(--mccsjs-card-bg);
  border-radius: 1rem;
...
.social-login {
  ...
  .social-buttons {
    ...
    .social-btn {
      ...
      &.github {
        color: var(--mccsjs-github-icon, #202328);
      }

      &.google {
        color: var(--mccsjs-google-icon, #5383ec);
      }

      &.qq {
        color: var(--mccsjs-qq-icon, #12b7f5);
      }

      &.microsoft {
        color: var(--mccsjs-microsoft-icon, #00a4ef);
      }

      &.oidc {
        color: var(--mccsjs-oidc-icon, var(--theme-color));
      }

      &.wechat {
        color: var(--mccsjs-wechat-icon, #07c160);
      }
    }
  }
}
...
:global([data-theme='light']) {
  --mccsjs-github-icon: #202328;
  --mccsjs-google-icon: #5383ec;
  --mccsjs-qq-icon: #12b7f5;
  --mccsjs-oidc-icon: #6366f1;
  --mccsjs-wechat-icon: #07c160;
}

:global([data-theme='dark']) {
  --mccsjs-github-icon: #f0f0f0;
  --mccsjs-google-icon: #8fb4ff;
  --mccsjs-qq-icon: #5cd9ff;
  --mccsjs-microsoft-icon: #41bce9;
  --mccsjs-oidc-icon: #a5b4fc;
  --mccsjs-wechat-icon: #07c160;
}
...
.close-btn {
  ...
  &:hover {
    background-color: var(--mccsjs-heavy-bg);
...
.login-form {
  ...
  .form-group {
    ...
    input {
      ...
      border: 2px solid var(--mccsjs-border);
      border-radius: 0.5rem;
      font-size: 1rem;
      color: var(--font-color);
      background-color: var(--mccsjs-heavy-bg);
...
@media screen and (max-width: 768px) {
  ...
  .modal-container {
    ...
    &::-webkit-scrollbar-thumb {
      background: var(--mccsjs-border, #e5e7eb);
      border-radius: 2px;
    }
  }
