...
// 使用评论 store
const { comments, fetchComments, addComment, removeComment, resetComments, flattenComments } =
  useComments();
...
const handleRefreshComments = async () => {
  await fetchComments(props.targetType, props.targetKey);
};
...
.emoji-hover-preview {
  ...
  animation: emojiPreviewIn 0.15s ease;
