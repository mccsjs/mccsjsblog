...
.toc-header {
  ...
  .header-left {
    ...
    i {
      font-size: 16px;
      color: var(--mccsjs-btn-hover, #49b1f5);
    }
  }
...
.toc-item {
  ...
  &::before {
    ...
    width: 3px;
    height: 0;
    background: var(--mccsjs-btn-hover, #49b1f5);
    border-radius: 0 2px 2px 0;
    transition: height 0.25s ease;
  }

  &:hover {
    background-color: color-mix(in srgb, var(--mccsjs-btn-hover) 8%, transparent);
    color: var(--font-color);
  ...
  &.active {
    background-color: var(--mccsjs-btn-hover, #49b1f5);
    color: #fff;
    font-weight: 500;
