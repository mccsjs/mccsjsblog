...
.toc-list {
  ...
  &::-webkit-scrollbar-thumb {
    background: color-mix(in srgb, var(--mccsjs-btn-hover) 50%, transparent);
    border-radius: 3px;

    &:hover {
      background: color-mix(in srgb, var(--mccsjs-btn-hover) 70%, transparent);
    }
  }
...
.toc-item {
  ...
  &:hover {
    ...
    border-left-color: var(--mccsjs-btn-hover);
  }

  &.active {
    background-color: var(--mccsjs-btn-hover);
    color: #fff;
    border-left-color: var(--mccsjs-btn-hover);
