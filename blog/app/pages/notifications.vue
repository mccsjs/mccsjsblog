...
.notification-list {
  .list-header {
    ...
    border-bottom: 1px solid var(--mccsjs-border, #e5e7eb);

    .title {
      margin: 0;
      font-size: 1rem;
      font-weight: 500;
      color: var(--mccsjs-font, #333);

      .count {
        font-size: 0.9rem;
        color: var(--mccsjs-secondary-text, #6b7280);
        font-weight: 400;
      }
    }
    ...
    .mark-all-btn {
      ...
      color: var(--mccsjs-secondary-text, #6b7280);
      border: 1px solid var(--mccsjs-border, #e5e7eb);
      ...
      &:hover {
        border-color: var(--mccsjs-primary, #3b82f6);
        color: var(--mccsjs-primary, #3b82f6);
      }
    }
  }
  ...
  .loading {
    ...
    text-align: center;
    font-size: 0.85rem;
    color: var(--mccsjs-secondary-text, #9ca3af);
  }

  .list-content {
    border: 1px solid var(--mccsjs-border, #e5e7eb);
    border-radius: 0.25rem;
    background-color: var(--mccsjs-card-bg, #fff);
    overflow: hidden;
  }
...
.notification-item {
  ...
  &:hover {
    background-color: var(--mccsjs-hover-bg, rgba(0, 0, 0, 0.01));
  }
  ...
  .unread-indicator {
    ...
    width: 6px;
    height: 6px;
    background-color: var(--mccsjs-primary, #3b82f6);
    border-radius: 50%;
  }
