...
if (initialData.value) {
  articles.value = (initialData.value.list || []).slice(0, 8);
        ...
        <div class="post-info">
          ...
          <div class="article-meta-wrap">
            ...
            <span v-if="article.category" class="article-meta">
              ...
              <NuxtLink v-if="article.category.url" class="article-meta__categories" :to="article.category.url">{{ article.category.name }}</NuxtLink><span v-else class="article-meta__categories">{{ article.category.name }}</span>
            </span>
