...
<template>
  <div id="subscribe-page">
    ...
    <UiBaseDialog
      ...
      :title="blogConfig.wechat_qrcode ? '关注公众号' : '公众号订阅'"
      confirm-text=""
    >
      <div class="wechat-dialog-content">
        <template v-if="blogConfig.wechat_qrcode">
          <p class="wechat-desc">
            扫描二维码关注公众号<br />
            获取最新文章推送
          </p>
          <div class="qrcode-wrapper">
            <NuxtImg
              :src="blogConfig.wechat_qrcode"
              :alt="blogConfig.wechat_name || '公众号二维码'"
              class="qrcode-image"
              loading="lazy"
            />
          </div>
          <p v-if="blogConfig.wechat_name" class="wechat-name">
            {{ blogConfig.wechat_name }}
          </p>
        </template>
        <template v-else>
          <p class="wechat-desc">
...
.subscribe-item {
  ...
  &.subscribe-wechat {
    background: var(--mccsjs-subscribe-wechat);
  }

  &.subscribe-mail {
    background: var(--mccsjs-subscribe-mail);
  }

  &.subscribe-rss {
    background: var(--mccsjs-subscribe-rss);
  }
