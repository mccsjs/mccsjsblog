<template>
  <div class="file-list-page">
    ...
    >
      ...
      <el-table-column prop="file_type" label="类型" width="120" align="center" class-name="hide-mobile" />
      ...
      <el-table-column prop="upload_type" label="用途" width="100" align="center" class-name="hide-mobile" />

      <el-table-column label="上传时间" width="180" align="center" class-name="hide-mobile">
        <template #default="{ row }">
        ...
        <template #default="{ row }">
          <template v-if="isMobile">
            <el-dropdown trigger="click">
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item @click="copyUrl(row)">复制链接</el-dropdown-item>
