<template>
  ...
  >
    <el-table v-loading="loading" :data="list" style="margin: 20px 0" max-height="350">
      ...
      <el-table-column prop="is_visible" label="展示" width="80" align="center" class-name="hide-mobile">
      ...
      <el-table-column prop="count" label="友链数" width="80" align="center" class-name="hide-mobile" />
      <el-table-column label="操作" :width="isMobile ? 100 : 100" align="center" :fixed="isMobile ? false : 'right'">
        <template #header>
          <el-button v-if="!isMobile" type="primary" plain size="small" @click="openForm()">新增</el-button>
        </template>
        <template #default="{ row }">
          <template v-if="isMobile">
            <el-dropdown trigger="click">
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item @click="openForm(row)">编辑</el-dropdown-item>
