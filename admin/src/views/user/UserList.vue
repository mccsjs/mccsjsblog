<template>
  <div class="user-list-page">
    ...
    >
      ...
      <el-table-column label="网站地址" min-width="150" align="center" class-name="hide-mobile">
        <template #default="{ row }">
      ...
      <el-table-column label="角色" width="120" align="center" class-name="hide-mobile">
        <template #default="{ row }">
      ...
      <el-table-column label="登录方式" width="150" align="center" class-name="hide-mobile">
        <template #default="{ row }">
      ...
      <el-table-column label="最后登录" width="180" align="center" class-name="hide-mobile">
        <template #default="{ row }">
