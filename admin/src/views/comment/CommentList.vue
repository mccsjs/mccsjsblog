<template>
  <div class="comment-list-page">
    ...
    >
      ...
      <el-table-column label="评论来源" width="220" align="center" class-name="hide-mobile">
        <template #default="{ row }">
          <div style="display: flex; align-items: center; gap: 8px">
      ...
      <el-table-column label="评论时间" width="180" align="center" class-name="hide-mobile">
        <template #default="{ row }">
          {{ formatDateTime(row.created_at) }}
        </template>
      </el-table-column>

      <el-table-column label="状态" width="100" align="center" class-name="hide-mobile">
        <template #default="{ row }">
          <el-switch
            v-model="row.status"
            :active-value="1"
      ...
      <el-table-column label="置顶" width="100" align="center" class-name="hide-mobile">
        <template #default="{ row }">
          <el-switch
        ...
        <template #default="{ row }">
          <template v-if="isMobile">
            <el-dropdown trigger="click">
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item @click="openReplyDialog(row)">回复</el-dropdown-item>
                  <el-dropdown-item @click="handleStatusChange(row)">
                    {{ row.status === 1 ? '隐藏' : '显示' }}
                  </el-dropdown-item>
                  <el-dropdown-item @click="handlePinned(row)">
