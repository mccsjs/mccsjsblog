<template>
  <div class="feedback-list-page">
    ...
    >
      ...
      <el-table-column label="联系方式" width="200" align="center" class-name="hide-mobile">
        <template #default="{ row }">
          <span v-if="row.email">{{ row.email }}</span>
        </template>
      </el-table-column>

      <el-table-column label="状态" width="120" align="center" class-name="hide-mobile">
        <template #default="{ row }">
      ...
      <el-table-column label="反馈时间" width="180" align="center" class-name="hide-mobile">
        <template #default="{ row }">
        ...
        <template #default="{ row }">
          <template v-if="isMobile">
            <el-dropdown trigger="click">
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item @click="handleView(row.id)">查看详情</el-dropdown-item>
