<template>
  <div class="article-list-page">
    ...
    >
      ...
      <el-table-column label="分类" width="120" align="center" class-name="hide-mobile">
        <template #default="{ row }">
      ...
      <el-table-column label="标签" width="200" align="center" class-name="hide-mobile">
        <template #default="{ row }">
          <el-tag
      ...
      <el-table-column label="发布地点" width="120" align="center" class-name="hide-mobile">
        <template #default="{ row }">
      ...
      <el-table-column label="统计" width="140" align="center" class-name="hide-mobile">
        <template #default="{ row }">
          <div
            style="
              display: flex;
      ...
      <el-table-column label="发布时间" width="180" align="center" class-name="hide-mobile">
        <template #default="{ row }">
      ...
      <el-table-column label="操作" :width="isMobile ? 100 : 180" align="center" :fixed="isMobile ? false : 'right'">
        <template #default="{ row }">
            ...
            <el-dropdown trigger="click">
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  ...
                  <el-dropdown-item @click="openExportDialog(row.id)">导出</el-dropdown-item>
