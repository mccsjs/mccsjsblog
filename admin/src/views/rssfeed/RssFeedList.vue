<template>
  <div class="rss-feed-list-page">
    ...
    >
      ...
      <el-table-column label="来源" width="180" class-name="hide-mobile">
        <template #default="{ row }">
      ...
      <el-table-column label="抓取时间" width="180" align="center" class-name="hide-mobile">
        <template #default="{ row }">
          {{ formatDateTime(row.created_at) }}
        </template>
      </el-table-column>

      <el-table-column label="操作" :width="isMobile ? 100 : 120" align="center" :fixed="isMobile ? false : 'right'">
        <template #default="{ row }">
          <template v-if="isMobile">
            <el-dropdown trigger="click">
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item v-if="!row.is_read && isSuperAdmin" @click="handleMarkRead(row)">
                    标记已读
                  </el-dropdown-item>
...
import { Message, Bell, Check, ArrowDown } from '@element-plus/icons-vue';
