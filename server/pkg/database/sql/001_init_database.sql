...
SELECT 
  ...
  '博客系统使用指南，包含环境要求、配置说明、启动步骤和默认管理员账号信息。',
  '',
  TRUE,
  TRUE,
  0,
...
-- 博客配置
INSERT INTO settings (key, value, "group", is_public) VALUES
('blog.title', 'Blog', 'blog', TRUE),
('blog.subtitle', 'Blog', 'blog', TRUE),
('blog.slogan', '分享技术，记录生活', 'blog', TRUE),
('blog.description', 'Blog - 基于 Go + Vue 的现代化博客系统', 'blog', TRUE),
...
('blog.about_versions', '[{"name":"Blog","version":"x.y.z"},{"name":"Vue","version":"3.5.0"},{"name":"Go","version":"1.25.0"}]', 'blog', TRUE),
...
SELECT '{"text":"欢迎使用 Blog 博客系统！这是一条示例动态。"}'::jsonb, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
WHERE NOT EXISTS (SELECT 1 FROM moments WHERE content->>'text' LIKE '%欢迎使用 Blog 博客系统%');
