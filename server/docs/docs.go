...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "collectionFormat": "csv",
                        "description": "文章文件（.md或.markdown格式，支持多文件）",
                        "name": "files",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/admin/articles/{id}/download/zip": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/articles/{id}/wechat/export": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/comments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "是否子评论（true:子评论, false:父评论）",
                        "name": "is_sub",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "评论开始时间（格式：2006-01-02）",
                        "name": "start_time",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "评论结束时间（格式：2006-01-02）",
                        "name": "end_time",
                        "in": "query"
                    }
                ],
        ...
        "/admin/comments/import": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "导入文件（JSON或Artrans格式）",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    },
        ...
        "/admin/users": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "搜索关键词（邮箱、昵称）",
                        "name": "keyword",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "角色筛选（super_admin/admin/user/guest）",
                        "name": "role",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "状态筛选（true:启用 false:禁用）",
                        "name": "is_enabled",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "是否已删除（true:已删除 false:未删除）",
                        "name": "is_deleted",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "登录方式筛选（password/github/google/qq/microsoft）",
                        "name": "login_method",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "最后登录开始时间（格式：2006-01-02）",
                        "name": "last_login_start",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "最后登录结束时间（格式：2006-01-02）",
                        "name": "last_login_end",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "注册开始时间（格式：2006-01-02）",
                        "name": "start_time",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "注册结束时间（格式：2006-01-02）",
                        "name": "end_time",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.WechatConfirmRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.WechatPollResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/auth/{provider}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "提供商 (github/google/qq)",
                        "name": "provider",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "操作类型：login(默认) 或 bind",
                        "name": "action",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "绑定时的认证token",
                        "name": "token",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "成功后跳转的页面路径",
                        "name": "redirect",
                        "in": "query"
                    }
                ],
        ...
        "/upload": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "上传类型：用户头像/评论贴图/反馈投诉",
                        "name": "type",
                        "in": "formData",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "dto.CollectRequest": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "类型: pageview/event/duration",
                    "type": "string"
                },
                "url": {
                    "description": "访问URL",
        ...
        "dto.MomentVideo": {
            ...
            "properties": {
                "platform": {
                    "description": "平台：bilibili, youtube（本地视频为空）",
                    "type": "string"
                },
                "url": {
                    "description": "视频URL（本地视频或在线视频链接）",
                    "type": "string"
                },
                "video_id": {
                    "description": "视频ID（在线视频的ID，本地视频为空）",
                    "type": "string"
                }
            }
        },
